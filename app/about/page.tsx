...
export default function AboutPage() {
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-[#EDF2F4] to-white p-8 md:p-12 rounded-2xl shadow-lg"
            >
              <div className="w-16 h-16 bg-gradient-to-br from-[#D80536] to-[#2B2E42] rounded-xl flex items-center justify-center mb-6">
                <Target className="text-white" size={32} />
              </div>
              <h2 className="text-3xl font-bold text-[#2B2E42] mb-4">
                Notre Mission
              </h2>
              <p className="text-[#8D9AAE] text-lg leading-relaxed">
                {aboutInfo.mission}
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-gray-50 to-white p-8 md:p-12 rounded-2xl shadow-lg"
            >
              <div className="w-16 h-16 bg-gradient-to-br from-[#2B2E42] to-[#D80536] rounded-xl flex items-center justify-center mb-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative h-96 bg-gradient-to-br from-[#EDF2F4] to-gray-100 rounded-2xl shadow-xl overflow-hidden mb-20"
          >
      ...
      {/* Valeurs */}
      <section className="py-20 bg-gradient-to-br from-gray-50 to-[#EDF2F4]">
        <div className="container mx-auto px-4">
          <motion.div
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-[#8D9AAE] max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#2B2E42] mb-2">
                    Formation Théorique
                  </h3>
                  <p className="text-[#8D9AAE] leading-relaxed">
      ...
      {/* Partenaires */}
      <section className="py-20 bg-gradient-to-br from-[#2B2E42] to-[#2B2E42] text-white">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="text-center p-8 bg-gradient-to-br from-[#EDF2F4] to-gray-50 rounded-2xl shadow-lg"
              >
                <div className="text-5xl md:text-6xl font-bold text-[#D80536] mb-2 font-[family-name:var(--font-poppins)]">
                  {stat.value}
                </div>
                <div className="text-[#8D9AAE] font-medium text-lg">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-[#EDF2F4]">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="max-w-4xl mx-auto text-center bg-gradient-to-br from-[#D80536] to-[#2B2E42] p-12 rounded-2xl shadow-2xl text-white"
          >
