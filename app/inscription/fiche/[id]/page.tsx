    ...
    <div className="min-h-screen bg-gray-50 py-8">
        ...
        <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2 bg-[#B22234] text-white rounded-lg hover:bg-[#800020] transition-colors font-semibold flex items-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
      ...
      <div className="max-w-4xl mx-auto px-4 mt-6 print:hidden">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 text-center">
          ...
          <button
            onClick={handleDownloadPDF}
            className="px-8 py-3 bg-[#B22234] text-white rounded-lg hover:bg-[#800020] transition-colors font-semibold inline-flex items-center gap-2 text-lg"
          >
            <svg
              className="w-6 h-6"
              fill="none"
